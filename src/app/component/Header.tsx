const Header = () =>(
     ...
     <div className=" grid grid-cols-1 divide-y-4 border-purple-600">
        <p  className=" bg-slate-700 text-slate-50">
            Get early access on launches and offers.Sign Up For Texts
        </p>
    
         <div>
            <div className="float-left mr-2 pl-25">Women</div>
            <div className="float-left mr-2">Men</div>
            <div className="float-left mr-2">About</div>
            <div className="float-left ">Everworld Stories</div>
