...
const Search = () => {
  return (
    <div>
      ...
      <div>
        <input  className="bg-gray-100 border  rounded-lg py-2 px-78 p-16px ml-83 mt-6 font-light " type="text" placeholder='Search' />
        <span>
            <button className='ml-5 font-light font-maison-neue mb-2 hover:underline'>Cancel</button>
        </span>
      </div>
      <div className='mt-9'>
      <hr></hr>
