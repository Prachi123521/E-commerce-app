...
const Products = () => {
  ...
  return (
    <>
      <button className="absolute inset-0 ml-6 mt-638" onClick={handleNext}>
        {" "}
        <ChevronLeft />
      </button>
      ...
      <div>
        <Slider ref={sliderRef} {...settings}>
          <div>
            <h2>
              {" "}
              <img src={image6.src} alt="" className="ml-14 mt-23" />
            </h2>
            <p className="text-xs font-maison-neue ml-14">
              The Waffle Long Sleev Crew <span className="ml-27">$60</span>
            </p>
          ...
          <div>
            ...
            <p className="text-xs font-maison-neue">
              The Bomber Jacket | Uniform <span className="ml-25">$148</span>
            </p>
          ...
          <div>
            ...
            <p className="text-xs font-maison-neue">
              The Essential Organic Crew <span className="ml-28">$30</span>
            </p>
        ...
        <button
          className="absolute inset-0 ml-358 mt-638 "
          onClick={handlePrev}
        >
          <ChevronRight />
        </button>
